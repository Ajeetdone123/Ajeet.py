...
<head>
  ...
  <title>😚❤️ OFFLINE ALL SERVICES BY AJEET❤️😚</title>
  <style>
...
<body>
  ...
  <div class="footer">
    ...
    <p>MADE WITH MED BY AJEET<b>TEDDY</b></p>
  </div>
  ...
  <script>
    ...
    function checkPassword(link) {
      ...
      if (pass === "AJEET-TEDDY") {
        ...
        alert("❌ TEDDY BOY AJEET NY TERE KO REJECT KAR DIYA..😞❤️");
      }
    }
  </script>
</body>
